...
public class LayerAssignerTest {
    ...
    public void assignLayers() throws Exception {
        ...
        DirectedEdge<DefaultVertex> e4 = new DirectedEdge<DefaultVertex>("e3","");
        DirectedEdge<DefaultVertex> e5 = new DirectedEdge<DefaultVertex>("e3","");
    ...
    public void LayerAssignerTest2(){
        ...
        DirectedEdge<DefaultVertex> e9 = new DirectedEdge<DefaultVertex>("e9","");
        DirectedEdge<DefaultVertex> e10 = new DirectedEdge<DefaultVertex>("e10","");
